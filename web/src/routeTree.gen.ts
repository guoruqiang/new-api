...
import { Route as AuthenticatedOauth2AuthRouteImport } from './routes/_authenticated/oauth2/auth'
...
const AuthenticatedOauth2AuthRoute = AuthenticatedOauth2AuthRouteImport.update({
  id: '/oauth2/auth',
  path: '/oauth2/auth',
  getParentRoute: () => AuthenticatedRouteRoute,
} as any)
...
export interface FileRoutesByFullPath {
  ...
  '/oauth2/auth': typeof AuthenticatedOauth2AuthRoute
...
export interface FileRoutesById {
  ...
  '/_authenticated/oauth2/auth': typeof AuthenticatedOauth2AuthRoute
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_authenticated/oauth2/auth': {
      id: '/_authenticated/oauth2/auth'
      path: '/oauth2/auth'
      fullPath: '/oauth2/auth'
      preLoaderRoute: typeof AuthenticatedOauth2AuthRouteImport
      parentRoute: typeof AuthenticatedRouteRoute
    }
    '/_authenticated/playground/': {
...
interface AuthenticatedRouteRouteChildren {
  ...
  AuthenticatedOauth2AuthRoute: typeof AuthenticatedOauth2AuthRoute
...
const AuthenticatedRouteRouteChildren: AuthenticatedRouteRouteChildren = {
  ...
  AuthenticatedOauth2AuthRoute: AuthenticatedOauth2AuthRoute,
