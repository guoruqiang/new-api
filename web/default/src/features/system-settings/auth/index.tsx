...
const defaultAuthSettings: AuthSettings = {
  ...
  'oauth_server.client_name': 'Cherry Studio Public Client',
  'oauth_server.client_id': '2a348c87-bae1-4756-a62f-b2e97200fd6d',
  'oauth_server.client_secret': '',
  'oauth_server.redirect_uris': 'cherrystudio://oauth/callback',
  'oauth_server.allowed_scopes':
    'openid profile email offline_access balance:read usage:read tokens:read tokens:write',
  'oauth_server.is_public': true,
  'oauth_server.require_pkce': true,
