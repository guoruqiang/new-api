...
const buildFormDefaults = (
  ...
  oauth_server: {
    ...
    client_secret: '',
    redirect_uris: splitLines(defaults['oauth_server.redirect_uris'] ?? '').join(
      '\n'
    ),
        ...
        <SettingsForm onSubmit={form.handleSubmit(onSubmit)}>
          ...
          <FormField
            ...
            render={({ field }) => (
              <SettingsSwitchItem>
                <SettingsSwitchContent>
                  <FormLabel>{t('Enable OAuth authorization server')}</FormLabel>
                  <FormDescription>
                    {t('Allow third-party clients to sign in through this site')}
                  </FormDescription>
                </SettingsSwitchContent>
                <FormControl>
                  <Switch
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription>
                  {t('Required for confidential clients. Public PKCE clients can leave it blank.')}
                </FormDescription>
                <FormMessage />
              </FormItem>
            )}
            ...
            render={({ field }) => (
              <SettingsSwitchItem>
                <SettingsSwitchContent>
                  ...
                  <FormDescription>
                    {t('Require S256 code challenge for authorization code flow')}
                  </FormDescription>
                </SettingsSwitchContent>
                <FormControl>
                  <Switch
